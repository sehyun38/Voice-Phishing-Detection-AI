...
# 설정
transcript_csv = '../dataset/Interactive_Dataset/Interactive_VP_Dataset_exaone_360_v3.csv'
keyword_csv = '../dataset/phishing_words.csv'
pt_save_path = 'token_weights_exaone.pt'
csv_save_path = 'token_weights_exaone.csv'
max_length = 360
