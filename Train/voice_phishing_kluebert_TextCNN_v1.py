...
def plot_metrics_from_lists(fold,train_metrics, val_metrics, save_path=f'../Result/TextCNN'):
...
def plot_roc_curve(fold, all_labels, all_probs, save_dir='../Result/TextCNN/ROCAUC'):
...
def report_evaluation(fold, metrics, dataset=None, val_idx=None):
    ...
    if dataset is not None and val_idx is not None:
        ...
        case_dir = f'../Result/TextCNN/case_samples/fold_{fold}'
...
if __name__ == '__main__':
    ...
    for train_idx, val_idx in skf.split(np.zeros(len(labels)), labels):
        ...
        model_dir = '../Result/TextCNN/model/'
