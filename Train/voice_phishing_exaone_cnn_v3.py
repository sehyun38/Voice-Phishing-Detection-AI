...
def plot_roc_curve(fold, all_labels, all_probs, save_dir='../Result/ROCAUC/CNN_v3',MODE = "SAVE"):
...
def report_evaluation(fold, metrics, dataset=None, val_idx=None):
    ...
    if dataset is not None and val_idx is not None:
        ...
        case_dir = f'../Result/case_samples/CNN_v3/fold_{fold}'
