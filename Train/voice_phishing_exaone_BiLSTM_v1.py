"""
Tokenizer : EXAONE 3.5 최대 32,768개의 토큰까지 가능(360 설정)
Model : BiLSTM
optimizer : Adam
epochs : 20
batch size : 32
...
def plot_metrics_from_lists(fold,train_metrics, val_metrics, save_path=f'../Result/BiLSTM_v1'):
...
def plot_roc_curve(fold, all_labels, all_probs, save_dir='../Result/BiLSTM_v1/ROCAUC'):
...
def report_evaluation(fold, metrics, dataset=None, val_idx=None):
    ...
    if dataset is not None and val_idx is not None:
        ...
        case_dir = f'../Result/BiLSTM_v1/case_samples/fold_{fold}'
...
if __name__ == '__main__':
    ...
    for train_idx, val_idx in skf.split(np.zeros(len(labels)), labels):
        ...
        model_dir = '../Result/BiLSTM_v1/model'
