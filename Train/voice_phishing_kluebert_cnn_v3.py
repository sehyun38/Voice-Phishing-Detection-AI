...
def plot_metrics_from_lists(fold,train_metrics, val_metrics, save_path=f'../Result/CNN_v3'):
...
def plot_roc_curve(fold, all_labels, all_probs, save_dir='../Result/CNN_v3/ROCAUC'):
...
def report_evaluation(fold, metrics, dataset=None, val_idx=None):
    ...
    if dataset is not None and val_idx is not None:
        ...
        case_dir = f'../Result/CNN_v3/case_samples/fold_{fold}'
