...
def plot_roc_curve(fold, all_labels, all_probs, save_dir='../Result/ROCAUC/BiLSTM_v1',MODE = "SAVE"):
...
def report_evaluation(fold, metrics, dataset=None, val_idx=None):
    ...
    if dataset is not None and val_idx is not None:
        ...
        case_dir = f'../Result/case_samples/BiLSTM_v1/fold_{fold}'
...
if __name__ == '__main__':
    ...
    for train_idx, val_idx in skf.split(np.zeros(len(labels)), labels):
        ...
        model_dir = '../Result/model/BiLSTM_v1'
