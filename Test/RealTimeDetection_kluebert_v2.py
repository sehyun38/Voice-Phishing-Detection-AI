...
from config import  DEVICE, tokenizer, VOCAB_SIZE, MAX_LENGTH
from models import BiLSTMAttention, TOKENIZER_NAME,  TextCNN, RCNN, KLUEBertModel, CNNModelV2, CNNModelV3
...
class VoicePhishingApp:
    ...
    def build_ui(self):
        ...
        self.threshold_slider = tk.Scale(self.root, from_=0, to=1, resolution=0.1, orient="horizontal",
    ...
    def change_model(self, selected_model_type):
        ...
        self.model = load_model(model_path_dynamic)
